...
(function e(t, i) {
     ...
     * @property {boolean} webgl - Enable WebGL rendering
     * @property {boolean} webglShadow - Enable WebGL shadows
     * @property {boolean} soundEnable - Enable page turn sound
     * @property {boolean} search - Enable search functionality
     * @property {string} height - Flipbook height (auto, number, or percentage)
     * @property {boolean} autoEnableOutline - Automatically enable PDF outline
     * @property {boolean} autoEnableThumbnail - Automatically enable thumbnails
     * @property {boolean} overwritePDFOutline - Overwrite PDF outline with custom
     * @property {boolean} enableDownload - Show download button
     * @property {number} duration - Page turn animation duration in ms
     * @property {number} direction - Reading direction (LTR or RTL)
     * @property {number} pageMode - Page display mode (SINGLE, DOUBLE, or AUTO)
     * @property {number} singlePageMode - Single page display mode (ZOOM, BOOKLET, or AUTO)
     * @property {string} backgroundColor - Background color
     * @property {boolean} forceFit - Force fit content to container
     * @property {boolean} transparent - Enable transparency
     * @property {string} hard - Hard cover style (none, single, double)
     * @property {number} openPage - Page to open on initialization
     * @property {string} annotationClass - CSS class for annotations
     * @property {boolean} autoPlay - Enable autoplay
     * @property {number} autoPlayDuration - Autoplay duration in ms
     * @property {boolean} autoPlayStart - Start autoplay on initialization
     * @property {number} maxTextureSize - Maximum texture size
     * @property {number} minTextureSize - Minimum texture size
     * @property {number} rangeChunkSize - Range chunk size for PDF rendering
     */
    var defaultConfig = t.defaults = {
        webgl: true,
        webglShadow: true,
        soundEnable: true,
        search: false,
